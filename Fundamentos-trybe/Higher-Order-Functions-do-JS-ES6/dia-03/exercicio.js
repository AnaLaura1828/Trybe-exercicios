...
// console.log(fantasyOrScienceFiction());j
...
const  oldBooks = () => books.filter((elemento) => elemento.releaseYear < new Date().getFullYear() - 60).map((elemento) => elemento.name)
...
// .filter((elemento) => elemento.endsWith('.')).length ===3 ).name
